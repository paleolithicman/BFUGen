...
typedef primate_bfu_mc::read_mc::reqPayload_t<NUM_THREADS_LG, NUM_REGS_LG> primate_bfu_req_t;
typedef primate_bfu_mc::read_mc::rspPayload_t<REG_WIDTH> primate_bfu_rsp_t;
